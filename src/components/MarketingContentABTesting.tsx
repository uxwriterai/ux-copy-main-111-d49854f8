...
import { ArrowUp, Upload, Target, BarChart, Users, CheckCircle, Upload as UploadIcon, Sliders, Goal, Code, MessageSquare } from "lucide-react";
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "./ui/accordion";

export const MarketingContentABTesting = () => {
  const scrollToTop = () => {
        ...
        <section className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Target, title: "AI-Powered Insights", description: "Compare Variations A and B with AI-generated suggestions for clarity, effectiveness, and alignment with user goals." },

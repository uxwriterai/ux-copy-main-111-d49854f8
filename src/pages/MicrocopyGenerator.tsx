...
const MicrocopyGenerator = () => {
  ...
  return (
    <>
      <Helmet>
        <title>AI Microcopy Creator — Generate UI Text Instantly</title>
        <meta name="description" content="Create perfect microcopy for your UI elements in seconds. AI-powered tool for buttons, forms, and menu text. Free, no signup needed." />
        ...
        <meta property="og:title" content="AI Microcopy Creator — Generate UI Text Instantly" />
        <meta property="og:description" content="Create perfect microcopy for your UI elements in seconds. AI-powered tool for buttons, forms, and menu text. Free, no signup needed." />
